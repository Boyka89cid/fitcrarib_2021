...
import 'package:fitcarib/ui/forgotpassword/otp/otp_presenter.dart';
import 'package:fitcarib/ui/otpexample/pin_entry_text.dart';

class OtpScreen extends BaseScreen
{
  OtpScreen(String title, listener) : super(title, listener);

  @override
  _OtpScreenState createState() => _OtpScreenState();
}

class _OtpScreenState extends BaseScreenState<OtpScreen, OtpPresenter> implements OtpContract{
